...
\label{sec:joian}
The constrains on the neutrino mass from cosmological observations, single beta decay and neutrinoless double beta decay experiments cannot be compared directly because they look into different observables, $\Sigma, m_{\beta}$ and $m_{\beta\beta}$. However, being functions of neutrino masses and oscillation parameters, $\Sigma, m_{\beta}$ and $m_{\beta\beta}$ could be analyzed together and cross check each other. 
